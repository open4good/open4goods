...
export default defineEventHandler(async (event): Promise<ContactResponseDto> => {
  ...
  try {
    ...
    console.error('Error forwarding contact message', backendError.logMessage, backendError)
