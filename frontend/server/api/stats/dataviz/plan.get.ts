...
import type { VerticalDatavizPlanDto } from '~~/shared/api-client'
...
export default defineEventHandler(
  async (event: H3Event): Promise<VerticalDatavizPlanDto> => {
    ...
    try {
      return await statsApi.datavizPlan({
        verticalId,
