    ...
    <div v-else class="compare-page__content">
      <section class="compare-section">
        <div class="compare-grid" role="table">
          ...
          <div class="compare-grid__media" role="row">
            <div class="compare-grid__feature compare-grid__feature--media" role="rowheader">
              <span class="compare-grid__feature-label compare-grid__feature-label--muted">
                {{ t('compare.headers.productOverview') }}
              </span>
            </div>
            <article
              v-for="product in products"
              :key="product.gtin"
              class="compare-grid__media-product"
              role="cell"
            >
                ...
                <div v-if="product" class="compare-grid__value-mobile">
                  <ClientOnly>
                    ...
                    >
                      ...
                      />
                      <div v-else class="compare-grid__value-mobile-placeholder" aria-hidden="true">
                        {{ productInitials(product.title) }}
                      </div>
                    </NuxtLink>
                  ...
                  <div class="compare-grid__value-mobile-details">
                    <p class="compare-grid__value-mobile-brand">{{ product.brand ?? '—' }}</p>
                    <p class="compare-grid__value-mobile-model">{{ productModelLabel(product) }}</p>
                  </div>
                </div>
...
.compare-page
  --compare-grid-sticky-offset: var(--v-layout-top, 72px)
  display: flex
...
.compare-grid__feature-label--muted
  font-size: 0.875rem
  color: rgba(var(--v-theme-text-neutral-soft), 0.9)

.compare-grid__media-product
  display: flex
  flex-direction: column
  align-items: center
  gap: 0.75rem
