...
export class CategoriesApi extends runtime.BaseAPI {
   ...
   * List categories
   */
  async categories1Raw(
    requestParameters: Categories1Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<VerticalConfigDto>>> {
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      jsonValue.map(VerticalConfigDtoFromJSON)
    )
  }
  ...
  async categories1(
    requestParameters: Categories1Request,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<VerticalConfigDto>> {
  ...
  async navigationRaw(
    ...
    if (requestParameters['googleCategoryId'] != null) {
      queryParameters['googleCategoryId'] =
        requestParameters['googleCategoryId']
    }
...
export type Categories1DomainLanguageEnum =
  (typeof Categories1DomainLanguageEnum)[keyof typeof Categories1DomainLanguageEnum]
/**
 * @export
 */
...
export type CategoryDomainLanguageEnum =
  (typeof CategoryDomainLanguageEnum)[keyof typeof CategoryDomainLanguageEnum]
/**
 * @export
 */
...
export type NavigationDomainLanguageEnum =
  (typeof NavigationDomainLanguageEnum)[keyof typeof NavigationDomainLanguageEnum]
