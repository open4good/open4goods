...
import type { FullPage, XwikiContentBlocDto } from '../models/index'
import {
  FullPageFromJSON,
  FullPageToJSON,
...
export class ContentApi extends runtime.BaseAPI {
  ...
  async contentBlocRaw(
  ...
  ): Promise<runtime.ApiResponse<XwikiContentBlocDto>> {
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      XwikiContentBlocDtoFromJSON(jsonValue)
    )
  }
  ...
  async pageRaw(
    ...
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<FullPage>> {
   ...
   */
  async pagesRaw(
    requestParameters: PagesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
...
export type PagesDomainLanguageEnum =
  (typeof PagesDomainLanguageEnum)[keyof typeof PagesDomainLanguageEnum]
