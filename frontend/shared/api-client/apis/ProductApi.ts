...
export class ProductApi extends runtime.BaseAPI {
   ...
   */
  async aggregatableFieldsRaw(
    requestParameters: AggregatableFieldsRequest,
   ...
   * Get aggregatable fields
   */
  async aggregatableFields(
    requestParameters: AggregatableFieldsRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<string>> {
    const response = await this.aggregatableFieldsRaw(
      requestParameters,
      initOverrides
    )
...
export type AggregatableFieldsDomainLanguageEnum =
  (typeof AggregatableFieldsDomainLanguageEnum)[keyof typeof AggregatableFieldsDomainLanguageEnum]
/**
 * @export
 */
...
export type ProductsSortEnum =
  (typeof ProductsSortEnum)[keyof typeof ProductsSortEnum]
/**
 * @export
 */
