...
import type { TeamProperties } from '../models/index'
import { TeamPropertiesFromJSON, TeamPropertiesToJSON } from '../models/index'
...
export type TeamDomainLanguageEnum =
  (typeof TeamDomainLanguageEnum)[keyof typeof TeamDomainLanguageEnum]
