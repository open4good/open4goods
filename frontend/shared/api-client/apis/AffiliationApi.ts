...
import type { ProblemDetail } from '../models/index'
import { ProblemDetailFromJSON, ProblemDetailToJSON } from '../models/index'
...
export class AffiliationApi extends runtime.BaseAPI {
   ...
   */
  async redirectGetRaw(
    requestParameters: RedirectGetRequest,
   ...
   */
  async redirectPostRaw(
    requestParameters: RedirectPostRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters['token'] == null) {
      throw new runtime.RequiredError(
...
export type RedirectGetDomainLanguageEnum =
  (typeof RedirectGetDomainLanguageEnum)[keyof typeof RedirectGetDomainLanguageEnum]
/**
 * @export
 */
...
export type RedirectPostDomainLanguageEnum =
  (typeof RedirectPostDomainLanguageEnum)[keyof typeof RedirectPostDomainLanguageEnum]
