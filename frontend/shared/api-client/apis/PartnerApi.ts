...
import type { AffiliationPartnerDto, StaticPartnerDto } from '../models/index'
import {
...
export class PartnerApi extends runtime.BaseAPI {
   ...
   */
  async affiliationPartnersRaw(
    requestParameters: AffiliationPartnersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<AffiliationPartnerDto>>> {
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      jsonValue.map(AffiliationPartnerDtoFromJSON)
    )
  }
   ...
   * List affiliation partners
   */
  async affiliationPartners(
    requestParameters: AffiliationPartnersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<AffiliationPartnerDto>> {
    const response = await this.affiliationPartnersRaw(
      requestParameters,
      initOverrides
    )
   ...
   */
  async ecosystemPartnersRaw(
    requestParameters: EcosystemPartnersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<StaticPartnerDto>>> {
    if (requestParameters['domainLanguage'] == null) {
      throw new runtime.RequiredError(
        'domainLanguage',
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      jsonValue.map(StaticPartnerDtoFromJSON)
    )
  }
   ...
   * List ecosystem partners
   */
  async ecosystemPartners(
    requestParameters: EcosystemPartnersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<StaticPartnerDto>> {
    const response = await this.ecosystemPartnersRaw(
      requestParameters,
      initOverrides
    )
    return await response.value()
   ...
   */
  async mentorPartnersRaw(
    requestParameters: MentorPartnersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<StaticPartnerDto>>> {
    if (requestParameters['domainLanguage'] == null) {
      throw new runtime.RequiredError(
   ...
   * List mentor partners
   */
  async mentorPartners(
    requestParameters: MentorPartnersRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<StaticPartnerDto>> {
    const response = await this.mentorPartnersRaw(
      requestParameters,
      initOverrides
    )
    return await response.value()
...
export type AffiliationPartnersDomainLanguageEnum =
  (typeof AffiliationPartnersDomainLanguageEnum)[keyof typeof AffiliationPartnersDomainLanguageEnum]
/**
 * @export
 */
...
export type EcosystemPartnersDomainLanguageEnum =
  (typeof EcosystemPartnersDomainLanguageEnum)[keyof typeof EcosystemPartnersDomainLanguageEnum]
/**
 * @export
 */
...
export type MentorPartnersDomainLanguageEnum =
  (typeof MentorPartnersDomainLanguageEnum)[keyof typeof MentorPartnersDomainLanguageEnum]
