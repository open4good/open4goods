...
export class FeedbackApi extends runtime.BaseAPI {
   ...
   */
  async listIssuesRaw(
    requestParameters: ListIssuesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<runtime.ApiResponse<Array<FeedbackIssueDto>>> {
    if (requestParameters['domainLanguage'] == null) {
      throw new runtime.RequiredError(
        'domainLanguage',
    ...
    return new runtime.JSONApiResponse(response, jsonValue =>
      jsonValue.map(FeedbackIssueDtoFromJSON)
    )
  }
  ...
  async listIssues(
    requestParameters: ListIssuesRequest,
    initOverrides?: RequestInit | runtime.InitOverrideFunction
  ): Promise<Array<FeedbackIssueDto>> {
    ...
    const response = await this.request(
      {
        ...
        headers: headerParameters,
        query: queryParameters,
        body: FeedbackSubmissionRequestDtoToJSON(
          requestParameters['feedbackSubmissionRequestDto']
        ),
      },
      initOverrides
    )
...
export type CanVoteDomainLanguageEnum =
  (typeof CanVoteDomainLanguageEnum)[keyof typeof CanVoteDomainLanguageEnum]
/**
 * @export
 */
...
export type ListIssuesDomainLanguageEnum =
  (typeof ListIssuesDomainLanguageEnum)[keyof typeof ListIssuesDomainLanguageEnum]
/**
 * @export
 */
...
export type ListIssuesTypeEnum =
  (typeof ListIssuesTypeEnum)[keyof typeof ListIssuesTypeEnum]
/**
 * @export
 */
...
export type RemainingVotesDomainLanguageEnum =
  (typeof RemainingVotesDomainLanguageEnum)[keyof typeof RemainingVotesDomainLanguageEnum]
/**
 * @export
 */
...
export type SubmitFeedbackDomainLanguageEnum =
  (typeof SubmitFeedbackDomainLanguageEnum)[keyof typeof SubmitFeedbackDomainLanguageEnum]
/**
 * @export
 */
...
export type VoteDomainLanguageEnum =
  (typeof VoteDomainLanguageEnum)[keyof typeof VoteDomainLanguageEnum]
