...
export function FullPageFromJSONTyped(json: any, ignoreDiscriminator: boolean): FullPage {
    if (json == null) {
        return json;
    }
    return {
...
export function FullPageToJSONTyped(value?: FullPage | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
