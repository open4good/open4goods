 ...
 */
export function instanceOfGoogleCategoryDto(
  value: object
): value is GoogleCategoryDto {
  return true
}
...
export function GoogleCategoryDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    children:
      json['children'] == null
        ? undefined
        : (json['children'] as Array<any>).map(GoogleCategoryDtoFromJSON),
  }
}
...
export function GoogleCategoryDtoToJSONTyped(
  value?: GoogleCategoryDto | null,
  ...
  return {
    ...
    children:
      value['children'] == null
        ? undefined
        : (value['children'] as Array<any>).map(GoogleCategoryDtoToJSON),
  }
}
