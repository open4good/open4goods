 ...
 */
export function instanceOfCommercialEvent(
  value: object
...
export function CommercialEventFromJSONTyped(
  json: any,
...
export function CommercialEventToJSONTyped(
  value?: CommercialEvent | null,
