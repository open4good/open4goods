 ...
 */
export function instanceOfAttributesConfigDto(
  value: object
): value is AttributesConfigDto {
  return true
}
...
export function AttributesConfigDtoFromJSONTyped(
  json: any,
  ...
  return {
    configs:
      json['configs'] == null
        ? undefined
        : (json['configs'] as Array<any>).map(AttributeConfigDtoFromJSON),
    featuredValues:
      json['featuredValues'] == null
        ? undefined
        : new Set(json['featuredValues']),
    exclusions:
      json['exclusions'] == null ? undefined : new Set(json['exclusions']),
  }
}
...
export function AttributesConfigDtoToJSONTyped(
  value?: AttributesConfigDto | null,
  ...
  return {
    configs:
      value['configs'] == null
        ? undefined
        : (value['configs'] as Array<any>).map(AttributeConfigDtoToJSON),
    featuredValues:
      value['featuredValues'] == null
        ? undefined
        : Array.from(value['featuredValues'] as Set<any>),
    exclusions:
      value['exclusions'] == null
        ? undefined
        : Array.from(value['exclusions'] as Set<any>),
  }
}
