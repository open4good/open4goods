...
export interface ProductNamesDto {
  ...
  /**
   * Card title for the requested language
   * @type {string}
   * @memberof ProductNamesDto
   */
  cardTitle?: string
  /**
   * Short name for the requested language
   * @type {string}
   * @memberof ProductNamesDto
   */
  shortName?: string
  /**
   * Long name for the requested language
   * @type {string}
   * @memberof ProductNamesDto
   */
  longName?: string
...
export function ProductNamesDtoFromJSONTyped(
  ...
  return {
    ...
    singularDesignation:
      json['singularDesignation'] == null
        ? undefined
        : json['singularDesignation'],
    metaDescription:
