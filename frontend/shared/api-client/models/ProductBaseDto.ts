 ...
 */
export function instanceOfProductBaseDto(
  value: object
): value is ProductBaseDto {
  return true
}
...
export function ProductBaseDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    externalIds:
      json['externalIds'] == null
        ? undefined
        : ProductExternalIdsDtoFromJSON(json['externalIds']),
    googleTaxonomyId:
      json['googleTaxonomyId'] == null ? undefined : json['googleTaxonomyId'],
    excluded: json['excluded'] == null ? undefined : json['excluded'],
    excludedCauses:
      json['excludedCauses'] == null
        ? undefined
        : new Set(json['excludedCauses']),
    gtinInfo:
      json['gtinInfo'] == null
        ? undefined
        : ProductGtinInfoDtoFromJSON(json['gtinInfo']),
    coverImagePath:
...
export function ProductBaseDtoToJSONTyped(
  value?: ProductBaseDto | null,
  ...
  return {
    ...
    excludedCauses:
      value['excludedCauses'] == null
        ? undefined
        : Array.from(value['excludedCauses'] as Set<any>),
