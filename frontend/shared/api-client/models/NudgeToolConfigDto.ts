 ...
 */
export function instanceOfNudgeToolConfigDto(value: object): value is NudgeToolConfigDto {
    return true;
}
...
export function NudgeToolConfigDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): NudgeToolConfigDto {
    if (json == null) {
        return json;
    }
    return {
...
export function NudgeToolConfigDtoToJSONTyped(value?: NudgeToolConfigDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
