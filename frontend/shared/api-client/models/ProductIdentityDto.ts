 ...
 */
export function instanceOfProductIdentityDto(
  value: object
): value is ProductIdentityDto {
  return true
}
...
export function ProductIdentityDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    shortestModel:
      json['shortestModel'] == null ? undefined : json['shortestModel'],
    akaModels:
      json['akaModels'] == null ? undefined : new Set(json['akaModels']),
    akaBrandsByDatasource:
      json['akaBrandsByDatasource'] == null
        ? undefined
        : json['akaBrandsByDatasource'],
    akaBrands:
      json['akaBrands'] == null ? undefined : new Set(json['akaBrands']),
  }
}
...
export function ProductIdentityDtoToJSONTyped(
  value?: ProductIdentityDto | null,
  ...
  return {
    ...
    akaModels:
      value['akaModels'] == null
        ? undefined
        : Array.from(value['akaModels'] as Set<any>),
    akaBrandsByDatasource: value['akaBrandsByDatasource'],
    akaBrands:
      value['akaBrands'] == null
        ? undefined
        : Array.from(value['akaBrands'] as Set<any>),
  }
}
