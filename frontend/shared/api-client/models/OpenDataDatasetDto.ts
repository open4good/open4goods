...
export type OpenDataDatasetDtoTypeEnum =
  (typeof OpenDataDatasetDtoTypeEnum)[keyof typeof OpenDataDatasetDtoTypeEnum]

/**
 * Check if a given object implements the OpenDataDatasetDto interface.
 */
export function instanceOfOpenDataDatasetDto(
  value: object
): value is OpenDataDatasetDto {
  return true
}
...
export function OpenDataDatasetDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    recordCountValue:
      json['recordCountValue'] == null ? undefined : json['recordCountValue'],
...
export function OpenDataDatasetDtoToJSONTyped(
  value?: OpenDataDatasetDto | null,
