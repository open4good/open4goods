 ...
 */
export function instanceOfAttributeParserConfig(value: object): value is AttributeParserConfig {
    return true;
}

export function AttributeParserConfigFromJSON(json: any): AttributeParserConfig {
    return AttributeParserConfigFromJSONTyped(json, false);
}

export function AttributeParserConfigFromJSONTyped(json: any, ignoreDiscriminator: boolean): AttributeParserConfig {
    if (json == null) {
        return json;
    }
    return {
        ...
        'removeParenthesis': json['removeParenthesis'] == null ? undefined : json['removeParenthesis'],
        'deleteTokens': json['deleteTokens'] == null ? undefined : json['deleteTokens'],
        'tokenMatch': json['tokenMatch'] == null ? undefined : json['tokenMatch'],
        'dimension': json['dimension'] == null ? undefined : json['dimension'],
        'defaultUnitHint': json['defaultUnitHint'] == null ? undefined : json['defaultUnitHint'],
    };
}
...
export function AttributeParserConfigToJSONTyped(value?: AttributeParserConfig | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
    ...
    return {
        ...
        'defaultUnitHint': value['defaultUnitHint'],
    };
}
