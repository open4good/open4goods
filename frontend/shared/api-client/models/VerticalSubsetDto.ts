 ...
 */
export function instanceOfVerticalSubsetDto(
  value: object
): value is VerticalSubsetDto {
  return true
}
...
export function VerticalSubsetDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    criterias:
      json['criterias'] == null
        ? undefined
        : (json['criterias'] as Array<any>).map(SubsetCriteriaFromJSON),
...
export function VerticalSubsetDtoToJSONTyped(
  value?: VerticalSubsetDto | null,
  ...
  return {
    ...
    group: value['group'],
    criterias:
      value['criterias'] == null
        ? undefined
        : (value['criterias'] as Array<any>).map(SubsetCriteriaToJSON),
    image: value['image'],
    url: value['url'],
