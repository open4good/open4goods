...
export type AgentIssueDtoPromptVisibilityEnum = typeof AgentIssueDtoPromptVisibilityEnum[keyof typeof AgentIssueDtoPromptVisibilityEnum];
...
export function AgentIssueDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgentIssueDto {
    if (json == null) {
        return json;
    }
    return {
...
export function AgentIssueDtoToJSONTyped(value?: AgentIssueDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
