 ...
 */
export function instanceOfProductScoreDto(
  value: object
): value is ProductScoreDto {
  return true
}
...
export function ProductScoreDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    absolute:
      json['absolute'] == null
        ? undefined
        : ProductCardinalityDtoFromJSON(json['absolute']),
    relativ:
      json['relativ'] == null
        ? undefined
        : ProductCardinalityDtoFromJSON(json['relativ']),
    metadatas: json['metadatas'] == null ? undefined : json['metadatas'],
    ranking: json['ranking'] == null ? undefined : json['ranking'],
    lowestScore:
      json['lowestScore'] == null
        ? undefined
        : ProductReferenceDtoFromJSON(json['lowestScore']),
    highestScore:
      json['highestScore'] == null
        ? undefined
        : ProductReferenceDtoFromJSON(json['highestScore']),
    percent: json['percent'] == null ? undefined : json['percent'],
    on20: json['on20'] == null ? undefined : json['on20'],
    absoluteValue:
      json['absoluteValue'] == null ? undefined : json['absoluteValue'],
    relativeValue:
      json['relativeValue'] == null ? undefined : json['relativeValue'],
...
export function ProductScoreDtoToJSONTyped(
  value?: ProductScoreDto | null,
