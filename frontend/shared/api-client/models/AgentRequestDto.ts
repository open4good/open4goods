...
export type AgentRequestDtoTypeEnum = typeof AgentRequestDtoTypeEnum[keyof typeof AgentRequestDtoTypeEnum];
...
export type AgentRequestDtoPromptVisibilityEnum = typeof AgentRequestDtoPromptVisibilityEnum[keyof typeof AgentRequestDtoPromptVisibilityEnum];


/**
 * Check if a given object implements the AgentRequestDto interface.
 */
export function instanceOfAgentRequestDto(value: object): value is AgentRequestDto {
...
export function AgentRequestDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgentRequestDto {
    if (json == null) {
        return json;
    }
    return {
...
export function AgentRequestDtoToJSONTyped(value?: AgentRequestDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
