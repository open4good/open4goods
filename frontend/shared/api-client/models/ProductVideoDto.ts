...
export type ProductVideoDtoResourceTypeEnum =
  (typeof ProductVideoDtoResourceTypeEnum)[keyof typeof ProductVideoDtoResourceTypeEnum]
...
export type ProductVideoDtoHardTagsEnum =
  (typeof ProductVideoDtoHardTagsEnum)[keyof typeof ProductVideoDtoHardTagsEnum]

/**
 * Check if a given object implements the ProductVideoDto interface.
 */
export function instanceOfProductVideoDto(
  value: object
): value is ProductVideoDto {
  return true
}
...
export function ProductVideoDtoFromJSONTyped(
  json: any,
...
export function ProductVideoDtoToJSONTyped(
  value?: ProductVideoDto | null,
