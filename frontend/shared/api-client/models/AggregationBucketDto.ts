 ...
 */
export function instanceOfAggregationBucketDto(
  value: object
): value is AggregationBucketDto {
  return true
}
...
export function AggregationBucketDtoFromJSONTyped(
  json: any,
...
export function AggregationBucketDtoToJSONTyped(
  value?: AggregationBucketDto | null,
