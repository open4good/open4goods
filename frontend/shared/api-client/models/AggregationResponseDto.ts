...
export type AggregationResponseDtoTypeEnum =
  (typeof AggregationResponseDtoTypeEnum)[keyof typeof AggregationResponseDtoTypeEnum]

/**
 * Check if a given object implements the AggregationResponseDto interface.
 */
export function instanceOfAggregationResponseDto(
  value: object
): value is AggregationResponseDto {
  return true
}

export function AggregationResponseDtoFromJSON(
  json: any
): AggregationResponseDto {
  return AggregationResponseDtoFromJSONTyped(json, false)
}

export function AggregationResponseDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    buckets:
      json['buckets'] == null
        ? undefined
        : (json['buckets'] as Array<any>).map(AggregationBucketDtoFromJSON),
    min: json['min'] == null ? undefined : json['min'],
    max: json['max'] == null ? undefined : json['max'],
  }
}

export function AggregationResponseDtoToJSON(
  json: any
): AggregationResponseDto {
  return AggregationResponseDtoToJSONTyped(json, false)
}

export function AggregationResponseDtoToJSONTyped(
  value?: AggregationResponseDto | null,
  ...
  return {
    ...
    buckets:
      value['buckets'] == null
        ? undefined
        : (value['buckets'] as Array<any>).map(AggregationBucketDtoToJSON),
    min: value['min'],
    max: value['max'],
  }
}
