 ...
 */
export function instanceOfAgentTemplateDto(value: object): value is AgentTemplateDto {
    return true;
}
...
export function AgentTemplateDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): AgentTemplateDto {
    if (json == null) {
        return json;
    }
    return {
...
export function AgentTemplateDtoToJSONTyped(value?: AgentTemplateDto | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
