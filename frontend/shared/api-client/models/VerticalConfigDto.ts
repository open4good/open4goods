 ...
 */
export function instanceOfVerticalConfigDto(
  value: object
): value is VerticalConfigDto {
  return true
}
...
export function VerticalConfigDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    averageHoursPerDay:
      json['averageHoursPerDay'] == null
        ? undefined
        : json['averageHoursPerDay'],
...
export function VerticalConfigDtoToJSONTyped(
  value?: VerticalConfigDto | null,
