...
export function ObjectsFromJSONTyped(
  json: any,
  ...
  return {
    ...
    objectSummaries:
      json['objectSummaries'] == null
        ? undefined
        : (json['objectSummaries'] as Array<any>).map(ObjectSummaryFromJSON),
  }
}
...
export function ObjectsToJSONTyped(
  value?: Objects | null,
  ...
  return {
    ...
    objectSummaries:
      value['objectSummaries'] == null
        ? undefined
        : (value['objectSummaries'] as Array<any>).map(ObjectSummaryToJSON),
  }
}
