...
export function ContactDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): ContactDetails {
    ...
    return {
        ...
        'countOfPublishedVersionsUsing': json['countOfPublishedVersionsUsing'] == null ? undefined : json['countOfPublishedVersionsUsing'],
        'orderNumber': json['orderNumber'] == null ? undefined : json['orderNumber'],
        'contactByReferenceId': json['contactByReferenceId'] == null ? undefined : json['contactByReferenceId'],
        'contactReference': json['contactReference'] == null ? undefined : json['contactReference'],
        ...
        'defaultContact': json['defaultContact'] == null ? undefined : json['defaultContact'],
        'countOfModelsUsed': json['countOfModelsUsed'] == null ? undefined : json['countOfModelsUsed'],
        'countOfPublishedModelsUsed': json['countOfPublishedModelsUsed'] == null ? undefined : json['countOfPublishedModelsUsed'],
