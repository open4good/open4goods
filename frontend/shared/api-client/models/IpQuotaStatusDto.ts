 ...
 */
export function instanceOfIpQuotaStatusDto(
  value: object
): value is IpQuotaStatusDto {
  return true
}
...
export function IpQuotaStatusDtoFromJSONTyped(
  json: any,
...
export function IpQuotaStatusDtoToJSONTyped(
  value?: IpQuotaStatusDto | null,
