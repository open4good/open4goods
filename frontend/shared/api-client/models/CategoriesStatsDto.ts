...
export function CategoriesStatsDtoFromJSONTyped(
  ...
  return {
    ...
    impactScoreProductsCount:
      json['impactScoreProductsCount'] == null
        ? undefined
        : json['impactScoreProductsCount'],
    productsWithoutVerticalCount:
      json['productsWithoutVerticalCount'] == null
        ? undefined
        : json['productsWithoutVerticalCount'],
    productsCountByCategory:
      json['productsCountByCategory'] == null
        ? undefined
        : json['productsCountByCategory'],
    productsCountSum:
      json['productsCountSum'] == null ? undefined : json['productsCountSum'],
    totalProductsCount:
      json['totalProductsCount'] == null
        ? undefined
        : json['totalProductsCount'],
    excludedProductsCount:
      json['excludedProductsCount'] == null
        ? undefined
        : json['excludedProductsCount'],
    ratedProductsCount:
      json['ratedProductsCount'] == null
        ? undefined
        : json['ratedProductsCount'],
    reviewedProductsCount:
      json['reviewedProductsCount'] == null
        ? undefined
        : json['reviewedProductsCount'],
    detailedStats:
      json['detailedStats'] == null
        ? undefined
        : mapValues(json['detailedStats'], VerticalStatsDtoFromJSON),
  }
}
  ...
  return {
    ...
    detailedStats:
      value['detailedStats'] == null
        ? undefined
        : mapValues(value['detailedStats'], VerticalStatsDtoToJSON),
  }
}
