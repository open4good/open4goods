...
export function VerticalConfigFullDtoFromJSONTyped(json: any, ignoreDiscriminator: boolean): VerticalConfigFullDto {
    ...
    return {
        ...
        'subCategories': json['subCategories'] == null ? undefined : ((json['subCategories'] as Array<any>).map(VerticalSubCategoryDtoFromJSON)),
...
export function VerticalConfigFullDtoToJSONTyped(value?: VerticalConfigFullDto | null, ignoreDiscriminator: boolean = false): any {
    ...
    return {
        ...
        'subCategories': value['subCategories'] == null ? undefined : ((value['subCategories'] as Array<any>).map(VerticalSubCategoryDtoToJSON)),
