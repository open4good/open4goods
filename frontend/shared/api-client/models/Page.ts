  ...
  return {
    ...
    translations:
      json['translations'] == null
        ? undefined
        : TranslationsFromJSON(json['translations']),
    ...
    hierarchy:
      json['hierarchy'] == null
        ? undefined
        : HierarchyFromJSON(json['hierarchy']),
  }
}
...
export function PageToJSONTyped(
  value?: Page | null,
  ...
  return {
    ...
    modified:
      value['modified'] == null ? undefined : value['modified'].toISOString(),
