...
export function ProductDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    base:
      json['base'] == null ? undefined : ProductBaseDtoFromJSON(json['base']),
    identity:
      json['identity'] == null
        ? undefined
        : ProductIdentityDtoFromJSON(json['identity']),
    names:
      json['names'] == null
        ? undefined
        : ProductNamesDtoFromJSON(json['names']),
    attributes:
      json['attributes'] == null
        ? undefined
        : ProductAttributesDtoFromJSON(json['attributes']),
    resources:
      json['resources'] == null
        ? undefined
        : ProductResourcesDtoFromJSON(json['resources']),
    datasources:
      json['datasources'] == null
        ? undefined
        : ProductDatasourcesDtoFromJSON(json['datasources']),
    scores:
      json['scores'] == null
        ? undefined
    ...
    aiReview:
      json['aiReview'] == null
        ? undefined
        : ProductAiReviewDtoFromJSON(json['aiReview']),
    eprel:
      json['eprel'] == null
        ? undefined
        : ProductEprelDtoFromJSON(json['eprel']),
    offers:
      json['offers'] == null
        ? undefined
        : ProductOffersDtoFromJSON(json['offers']),
    timeline:
      json['timeline'] == null
        ? undefined
        : ProductTimelineDtoFromJSON(json['timeline']),
  }
}
...
export function ProductDtoToJSONTyped(
