 ...
 */
export function instanceOfGlobalSearchRequestDto(
  value: object
): value is GlobalSearchRequestDto {
  return true
}

export function GlobalSearchRequestDtoFromJSON(
  json: any
): GlobalSearchRequestDto {
  return GlobalSearchRequestDtoFromJSONTyped(json, false)
}

export function GlobalSearchRequestDtoFromJSONTyped(
  json: any,
...
export function GlobalSearchRequestDtoToJSON(
  json: any
): GlobalSearchRequestDto {
  return GlobalSearchRequestDtoToJSONTyped(json, false)
}

export function GlobalSearchRequestDtoToJSONTyped(
  value?: GlobalSearchRequestDto | null,
