 ...
 */
export function instanceOfGlobalSearchResponseDto(
  value: object
): value is GlobalSearchResponseDto {
  return true
}

export function GlobalSearchResponseDtoFromJSON(
  json: any
): GlobalSearchResponseDto {
  return GlobalSearchResponseDtoFromJSONTyped(json, false)
}

export function GlobalSearchResponseDtoFromJSONTyped(
  json: any,
  ...
  return {
    verticalGroups:
      json['verticalGroups'] == null
        ? undefined
        : (json['verticalGroups'] as Array<any>).map(
            GlobalSearchVerticalGroupDtoFromJSON
          ),
    missingVerticalResults:
      json['missingVerticalResults'] == null
        ? undefined
        : (json['missingVerticalResults'] as Array<any>).map(
            GlobalSearchResultDtoFromJSON
          ),
    missingVerticalPage:
      json['missingVerticalPage'] == null
        ? undefined
        : GlobalSearchPageMetaDtoFromJSON(json['missingVerticalPage']),
    verticalCta:
...
export function GlobalSearchResponseDtoToJSON(
  json: any
): GlobalSearchResponseDto {
  return GlobalSearchResponseDtoToJSONTyped(json, false)
}

export function GlobalSearchResponseDtoToJSONTyped(
  value?: GlobalSearchResponseDto | null,
  ...
  return {
    verticalGroups:
      value['verticalGroups'] == null
        ? undefined
        : (value['verticalGroups'] as Array<any>).map(
            GlobalSearchVerticalGroupDtoToJSON
          ),
    missingVerticalResults:
      value['missingVerticalResults'] == null
        ? undefined
        : (value['missingVerticalResults'] as Array<any>).map(
            GlobalSearchResultDtoToJSON
          ),
    missingVerticalPage: GlobalSearchPageMetaDtoToJSON(
