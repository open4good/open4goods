 ...
 *
 * @export
 * @interface ProductPdfDto
 */
export interface ProductPdfDto {
  /**
   * Resource URL
   * @type {string}
   * @memberof ProductPdfDto
   */
  url?: string
  /**
   * Detected MIME type
   ...
   * @memberof ProductPdfDto
   */
  status?: ProductPdfDtoStatusEnum | null
  /**
   ...
   * @memberof ProductPdfDto
   */
  resourceType?: ProductPdfDtoResourceTypeEnum
  /**
   ...
   * @memberof ProductPdfDto
   */
  hardTags?: Set<ProductPdfDtoHardTagsEnum>
  /**
 ...
 * @export
 */
export const ProductPdfDtoStatusEnum = {
 ...
 * @export
 */
export const ProductPdfDtoResourceTypeEnum = {
  Image: 'IMAGE',
  Pdf: 'PDF',
  Unknown: 'UNKNOWN',
  Video: 'VIDEO',
} as const
export type ProductPdfDtoResourceTypeEnum =
  (typeof ProductPdfDtoResourceTypeEnum)[keyof typeof ProductPdfDtoResourceTypeEnum]

/**
 * @export
 */
export const ProductPdfDtoHardTagsEnum = {
...
export type ProductPdfDtoHardTagsEnum =
  (typeof ProductPdfDtoHardTagsEnum)[keyof typeof ProductPdfDtoHardTagsEnum]

/**
 * Check if a given object implements the ProductPdfDto interface.
 */
export function instanceOfProductPdfDto(value: object): value is ProductPdfDto {
  return true
}

export function ProductPdfDtoFromJSON(json: any): ProductPdfDto {
  return ProductPdfDtoFromJSONTyped(json, false)
}

export function ProductPdfDtoFromJSONTyped(
  json: any,
  ...
  return {
    ...
    extractedTitle:
      json['extractedTitle'] == null ? undefined : json['extractedTitle'],
    numberOfPages:
      json['numberOfPages'] == null ? undefined : json['numberOfPages'],
    ...
    modificationDate:
      json['modificationDate'] == null ? undefined : json['modificationDate'],
    producer: json['producer'] == null ? undefined : json['producer'],
    language: json['language'] == null ? undefined : json['language'],
    languageConfidence:
      json['languageConfidence'] == null
        ? undefined
        : json['languageConfidence'],
  }
}

export function ProductPdfDtoToJSON(json: any): ProductPdfDto {
  return ProductPdfDtoToJSONTyped(json, false)
}

export function ProductPdfDtoToJSONTyped(
  value?: ProductPdfDto | null,
