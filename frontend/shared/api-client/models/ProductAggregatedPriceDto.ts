...
export interface ProductAggregatedPriceDto {
   ...
   * @memberof ProductAggregatedPriceDto
   */
  shortPrice?: string | null
  /**
   * Available stock quantity reported by the merchant
   * @type {number}
   * @memberof ProductAggregatedPriceDto
   */
  quantityInStock?: number | null
  /**
   * Shipping cost reported by the merchant, in the offer currency
   * @type {number}
   * @memberof ProductAggregatedPriceDto
   */
  shippingCost?: number | null
  /**
   * Shipping delay reported by the merchant, in days
   * @type {number}
   * @memberof ProductAggregatedPriceDto
   */
...
export function ProductAggregatedPriceDtoFromJSONTyped(
  ...
  return {
    ...
    quantityInStock:
      json['quantityInStock'] == null ? undefined : json['quantityInStock'],
    shippingCost:
      json['shippingCost'] == null ? undefined : json['shippingCost'],
    shippingTimeDays:
      json['shippingTimeDays'] == null ? undefined : json['shippingTimeDays'],
  }
}
...
export function ProductAggregatedPriceDtoToJSONTyped(
  ...
  return {
    ...
    shippingTimeDays: value['shippingTimeDays'],
  }
}
