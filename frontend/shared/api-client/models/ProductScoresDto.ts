...
export function ProductScoresDtoFromJSONTyped(
  ...
  return {
    ...
    worstScores:
      json['worstScores'] == null ? undefined : new Set(json['worstScores']),
    bestScores:
      json['bestScores'] == null ? undefined : new Set(json['bestScores']),
    ranking:
      json['ranking'] == null
        ? undefined
...
export function ProductScoresDtoToJSONTyped(
  ...
  return {
    ...
    worstScores:
      value['worstScores'] == null
        ? undefined
        : Array.from(value['worstScores'] as Set<any>),
    bestScores:
      value['bestScores'] == null
        ? undefined
        : Array.from(value['bestScores'] as Set<any>),
