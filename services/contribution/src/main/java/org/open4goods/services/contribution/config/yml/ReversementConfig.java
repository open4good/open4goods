package org.open4goods.services.contribution.config.yml;
...
public class ReversementConfig {
    ...
    /**
     * The list of reversements (cashback) to ecological organisations that have already been operated
     */
     ...
     * TODO : I18n
     */
    private Map<String, ContributedOrganisation> contributedOrganisations = new HashMap<>();
    ...
    public LocalDate getLastReversementDate() {
        return getReversements().stream().map(Reversement::getDate).max(LocalDate::compareTo)
