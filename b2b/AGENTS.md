# Nudger B2B application — AGENTS Guide

## 1. Mission
Provide a **clear and fully documented REST API** for the B2B customers  
...
A minimal ui (bootstrap 5) will be provided through Thymeleaf
---
