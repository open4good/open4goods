...
/**
 * REST controller exposing XWiki full pages
 */
@RestController
@RequestMapping
@Validated
@PreAuthorize("hasAnyAuthority('" + RolesConstants.ROLE_FRONTEND + "', '" + RolesConstants.ROLE_EDITOR + "')")
@Tag(name = "Content", description = "Content pages")
public class ContentsController {

    private final XwikiFullPageService xwikiFullPageService;

    public ContentsController(XwikiFullPageService xwikiFullPageService) {
    ...
    @Cacheable(cacheNames = CacheConstants.ONE_DAY_LOCAL_CACHE_NAME, keyGenerator = CacheConstants.KEY_GENERATOR)
