...
/**
 * Authenticates the dedicated Spring Boot Admin identity for front-api Actuator endpoints.
 *
 * <p>It returns {@code null} for every other identity, leaving consumer and XWiki authentication
 * unchanged. A password mismatch for the configured monitor identity is terminal so a monitor
 * request is never forwarded to XWiki.
 */
