...
public record CommercialEventDto(
        @Schema(description = "Localised event label.", example = "Black Friday")
        String label,

        @Schema(description = "Inclusive event start date.", type = "string", format = "date", example = "2025-11-28")
        LocalDate startDate,
