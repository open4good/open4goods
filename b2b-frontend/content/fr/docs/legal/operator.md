---
title: "Accord de l'opérateur de nœud"
description: "*Dernière mise à jour : 04/05/2026*"
tags:
  - documentation
  - vue-content
  - structural
...
doc_url: /docs/apps/frontend/content/fr/docs/legal/operator
doc_path: apps/frontend/content/fr/docs/legal/operator.md
rag_chunking: heading
metadata_last_synced: 2026-05-08
---
# Accord de l'opérateur de nœud
...
## 4. Conformité
Vous acceptez de vous conformer à toutes les réglementations locales concernant le calcul et le traitement des données.
