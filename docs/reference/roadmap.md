...
| m7-product-data-reference | 20 | 3 | 17 | 0 | 0 |
...
| [reference-api-frontend-breaking-cutover](../../.o4g/work/reference-api-frontend-breaking-cutover.yml) | ACCEPTED | BLOCKED | reference-resolution-and-surface-projections, product-family-model-grouping | reference-resolution-and-surface-projections, product-family-model-grouping | Move consumer, B2B and open-data readers to typed licensed projections in one coordinated API version change. |
