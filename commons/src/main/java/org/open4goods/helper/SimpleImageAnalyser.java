...
public class SimpleImageAnalyser {
	private int height;
	private int width;
	private String mimeType;

	public SimpleImageAnalyser(final File file) throws IOException {
	...
	public SimpleImageAnalyser(final InputStream is) throws IOException {
		processStream(is);
	}

	public SimpleImageAnalyser(final byte[] bytes) throws IOException {
