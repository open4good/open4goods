...
//	}
	...
	public static class EmbeddingConfig {
		 ...
		 * <li>Example: "djl://ai.djl.pytorch/resnet50" (pure vision, no
		 * multimodal)</li>
		 * </ul>
		 */
		private String visionModelUrl = "djl://ai.djl.p/open4goods/api/src/main/java/org/open4goods/api/config/yml/ApiProperties.javaytorch/resnet/0.0.1?layers=18&dataset=imagenet";

		/**
		 * Text-only embedding model for improved semantic search. Default: multilingual
		 * E5.
		 */
		...
		/**
		 * If true, application startup fails when neither the text nor the multimodal
		 * model can be loaded (after applying local/remote selection rules).
		 */
		...
		public void setVisionModelUrl(String multimodalModelUrl) {
			this.visionModelUrl = multimodalModelUrl;
		}
