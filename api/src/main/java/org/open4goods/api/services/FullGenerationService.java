 ...
 *
 */
public class FullGenerationService {

	protected static final Logger logger = LoggerFactory.getLogger(FullGenerationService.class);
	...
	@Autowired
	public FullGenerationService(DataFragmentRepository repository, EvaluationService evaluationService,
